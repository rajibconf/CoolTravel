...
class TravelRecommendation(APIView):
    ...
    def post(self, request):
        ...
        travel_date_forecast = datetime.strptime(travel_date, "%d-%m-%Y").replace(hour=14, minute=0) # noqa
        ...
        def fetch_and_process_district(district):
            try:
                ...
                forecast = TemperatureForecast(
                    ...
                    timezone_abbreviation=data_dict["timezone_abbreviation"], # noqa
        ...
        try:
            ...
            return Response({
                "error": "Data not found for the given location and travel date" # noqa
            }, status=400)
